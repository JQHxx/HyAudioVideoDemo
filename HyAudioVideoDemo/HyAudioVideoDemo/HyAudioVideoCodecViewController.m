...
- (void)hy_viewDidLoad {
    ...
    self.navigationItem.title = @"编码-解码";
    ...
    labelOne.frame = CGRectMake(12, naviHeight + 20, self.view.width, 50);
    [self.view addSubview:labelOne];
    
    UILabel *labelTwo = UILabel.new;
    labelTwo.text = @"解码 - 播放";
    labelTwo.frame = CGRectMake(12, naviHeight + self.videoH + 20+ 50, self.view.width, 50);
...
- (id<HyAVCaptureProtocol>)avCapturer {
    if (!_avCapturer){
        ...
        videoCapture.preViewLayer.frame = CGRectMake(0, naviHeight + 50 + 20, self.view.bounds.size.width, self.videoH);
